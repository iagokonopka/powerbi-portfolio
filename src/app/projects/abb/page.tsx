  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Project Details */}
        <section className="bg-neutral-900 rounded-lg p-6 md:p-8 mb-8">
        ...
        {/* Embedded Power BI */}
        <section className="bg-neutral-900 rounded-lg p-6 md:p-8">
          <h2 className="text-2xl font-semibold mb-4">Dashboard Interativo</h2>
          <div className="aspect-video bg-neutral-800 flex items-center justify-center text-neutral-400">
            <iframe 
